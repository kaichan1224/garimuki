...
public class TamingManager : MonoBehaviour
{
    ...
    [SerializeField] private int gariRankPower = 1;
    [SerializeField] private int normalRankPower = 3;
    [SerializeField] private int mukiRankPower = 5;
    ...
    public void TameComplete()
    {
        ...
        Sequence sequence = DOTween.Sequence();
        sequence
            .AppendCallback(() => resultText.text = "Tame Conplete")
            .AppendInterval(3f)
            .OnComplete(() =>
            {
    ...
    public void TameFailed()
    {
        ...
        Sequence sequence = DOTween.Sequence();
        sequence
            .AppendCallback(() => resultText.text = "Tame Failed")
            .AppendInterval(3f)
            .OnComplete(() =>
            {
                tameResultPanel.SetActive(false);
    ...
    public void TameOver()
    {
        ...
        Sequence sequence = DOTween.Sequence();
        sequence
            .AppendCallback(() => resultText.text = "Time Over!!!")
            .AppendInterval(3f)
            .OnComplete(() =>
            {
                tameResultPanel.SetActive(false);
    ...
    void Taming()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            currentEnemyHp -= enemyPower;
        }
        enemyTimer -= Time.deltaTime;
        if (enemyTimer < 0)
        {
            currentPlayerHp -= Random.Range(1, enemyPower);
